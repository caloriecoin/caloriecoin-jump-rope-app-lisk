    ...
    if(disabled)
    {
        return <View style={{flex:1, justifyContent:'center', alignItems:'center',marginTop:125}}>
            <RadialGradient style={{width:200,height:100}}
                        ...
                        center={[100,100]}
                        radius={80}/>
            <Text style={{fontFamily:'SUIT-SemiBold', color:'white', fontSize:20,marginTop:40}}>매치 대기 중</Text>
            <Text style={{fontFamily:'SUIT-SemiBold', color:'#92929d', fontSize:18, marginTop:18}}>상대</Text>
        </View>
    }
    else
    {
